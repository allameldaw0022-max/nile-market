...
> قيم الحدود لكل باقة **لم تُحدَّد بعد** — سؤال **Q4**. حتى ذلك الحين
...
- `expired` ⇒ المتجر حسب Q2، واللوحة للقراءة فقط.
...
| `notify_expiring` | يوميًا 08:00 (Africa/Khartoum) | تنبيهات قبل 7 و3 و1 يوم (بانتظار Q3) + `dedupe_key` يمنع التكرار |
