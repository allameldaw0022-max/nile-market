...
>
> **المرحلة الحالية: PLANNING (مكتملة — بانتظار الاعتماد).**
> لا يبدأ التنفيذ الكامل قبل حسم الأسئلة في `OPEN-QUESTIONS.md`.
...
| [`OPEN-QUESTIONS.md`](./OPEN-QUESTIONS.md) | **القرارات المطلوبة منك قبل التنفيذ** (مال / صلاحيات / بيانات) |
