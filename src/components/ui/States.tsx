...
export function EmptyState({ icon, title, description, action }: {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[--radius-lg]
                    border border-dashed border-sand-300 bg-white px-6 py-14 text-center">
      <div className="mb-3 text-sand-400">{icon ?? <Inbox size={36} strokeWidth={1.5} />}</div>
    ...
    <div className="rounded-[--radius-lg] border border-gold-500/40 bg-gold-400/10 p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-navy-900">وصلت إلى حد باقتك</h3>
...
export function OfflineBanner() {
  return (
    <div role="status"
         className="flex items-center justify-center gap-2 bg-navy-900 px-4 py-2
...
export function CardSkeleton() {
  return (
    <div className="rounded-[--radius-lg] border border-sand-200 bg-white p-4">
